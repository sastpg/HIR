...
def main(args):
    ...
    is_follow, num = save_evaluate_example_constraint(
    ...
    is_follow_cons, num_cons = [], []
    for constraint_type in args.constraint_types:
        is_follow, num = save_discriminative_evaluation(
                                        data_path=args.data_path,
                                        api_output_path=args.api_output_path,
        ...
        is_follow_cons.append(is_follow)
        num_cons.append(num)
        save_csl_evaluation(
                            data_path=args.data_path,
                            api_output_path=args.api_output_path,
    ...
    print(f"Evaluation results: {sum(is_follow_cons) / sum(num_cons)}")
    breakpoint()
